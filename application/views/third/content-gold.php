	...
	=============================================-->
	<div class="breadcrumb-area breadcrumb-bg-2 pt-50 pb-70 mb-10">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="breadcrumb-title">Our Product</h1>
				...
				<div class="col-md-6 mb-30"  style="background-color: #dccca7; height: 400px;">
					<div class="cosmetics-home-intro mt-50">
						...
						<div class="tp-caption   tp-resizeme" id="slide-14-layer-11" data-x="['left','left','left','left']"
							...
							Christian Breton Serum Elixir dengan teknologi cryotherapy yang pastinya<br> dapat mengencangkan kulit didaerah mata serta kandungan hyaluronic <br>acid dan matrixyl dapat membantu pertumbuhan regenerasi sel dan <br>memperlambat proses penuaan kulit.  <br> <br><br>
							<div class="tp-caption   tp-resizeme" id="slide-14-layer-9" data-x="['left','left','left','left']"
							data-hoffset="['287','93','89','21']" data-y="['top','top','top','top']"
							data-voffset="['170','73','58','108']" data-width="none" data-height="none" data-whitespace="nowrap"
							data-type="text" data-responsive_offset="on"
				...
				<div class="col-md-6 mb-30" style="background-color: #dccca7; height: 400px;">
					<div class="cosmetics-home-intro mt-50">
						<div class="tp-caption   tp-resizeme" id="slide-14-layer-10" data-x="['left','left','left','left']"
							...
							data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
							data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
							style="z-index: 12; white-space: nowrap; font-size: 20px; line-height: 64px; font-weight: 400; color: #333333; letter-spacing: 0px;font-family:Work Sans;">
							CHRISTIAN BRETON SERUM ELIXIR  <br>
							</div>
						...
						<div class="tp-caption   tp-resizeme" id="slide-14-layer-11" data-x="['left','left','left','left']"
							...
							data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
							style="z-index: 13; white-space: nowrap; font-size: 15px; line-height: 26px; font-weight: 400; color: #7e7e7e; letter-spacing: 0.5px;font-family:Work Sans;">
							Christian Breton Serum Elixir dengan teknologi cryotherapy yang pastinya<br> dapat mengencangkan kulit didaerah mata serta kandungan hyaluronic <br>acid dan matrixyl dapat membantu pertumbuhan regenerasi sel dan <br>memperlambat proses penuaan kulit. <br> consectetur cing elit. </div>
